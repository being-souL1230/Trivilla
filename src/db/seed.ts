...
async function main() {
  ...
  const menu = await db
    ...
    .values([
      ...
      { name: "Paneer Butter Masala", description: "Soft paneer in creamy tomato-cashew gravy, finished with kasuri methi.", category: "Main Course", price: 299, veg: true, popular: true, spice: 1, prepTime: 18, image: IMG.paneerButter },
      { name: "Dal Makhani", description: "Black urad simmered overnight on slow fire with butter & cream.", category: "Main Course", price: 229, veg: true, spice: 1, prepTime: 15, image: IMG.dalMakhani },
      ...
      { name: "Paneer Pakora", description: "Crisp besan-fried paneer bites with mint chutney.", category: "Starters", price: 189, veg: true, spice: 2, prepTime: 12, image: IMG.pakora },
      ...
      { name: "Kesar Kulfi", description: "Slow-churned saffron kulfi with pista crunch.", category: "Desserts", price: 129, veg: true, spice: 0, prepTime: 5, image: IMG.kulfi },
      { name: "Masala Chai", description: "Kulhad chai brewed with ginger, cardamom & lots of love.", category: "Drinks", price: 59, veg: true, spice: 0, prepTime: 5, image: IMG.chai },
      { name: "Sweet Lassi", description: "Thick churned curd drink topped with malai & a pinch of kesar.", category: "Drinks", price: 79, veg: true, spice: 0, prepTime: 5, image: IMG.drinks, popular: true },
      { name: "Masala Chaas", description: "Cool spiced buttermilk with jeera, mint & black salt.", category: "Drinks", price: 49, veg: true, spice: 0, prepTime: 4, image: IMG.drinks },
      { name: "Fresh Lime Soda", description: "Sweet, salted or mixed — squeezed to order with mint.", category: "Drinks", price: 89, veg: true, spice: 0, prepTime: 4, image: IMG.drinks },
      { name: "Green Garden Salad", description: "Cucumber, tomato, carrot & lettuce with lemon dressing.", category: "Sides", price: 69, veg: true, spice: 0, prepTime: 5, image: IMG.sides },
      { name: "Laccha Onion Salad", description: "Thin onion rings with lemon, chilli & chaat masala.", category: "Sides", price: 59, veg: true, spice: 1, prepTime: 5, image: IMG.sides },
      { name: "Boondi Raita", description: "Cool curd with crispy boondi & roasted jeera.", category: "Sides", price: 69, veg: true, spice: 0, prepTime: 4, image: IMG.sides },
      { name: "Fresh Curd (Dahi)", description: "Set in-house every morning — thick & cooling.", category: "Sides", price: 49, veg: true, spice: 0, prepTime: 2, image: IMG.sides },
